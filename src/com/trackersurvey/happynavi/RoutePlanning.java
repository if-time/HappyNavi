...
public class RoutePlanning extends Activity implements OnMarkerClickListener,
	...
	private void startImagePoint() {
		ToastUtil.show(RoutePlanning.this, "在地图上点击您的起点");
		isClickStart = true;
		isClickTarget = false;
		registerListener();
	}
	...
	private void endImagePoint() {
		ToastUtil.show(RoutePlanning.this, "在地图上点击您的终点");
		isClickTarget = true;
		isClickStart = false;
		registerListener();
	}
	...
	private void busRoute() {
		...
		drivingButton.setBackgroundResource(R.drawable.mode_driving_off);//按下按钮图标切换
	...
	public void searchRoute() {
		...
		if (strStart == null || strStart.length() == 0) {
			ToastUtil.show(RoutePlanning.this, "请选择起点");
			return;
		}
		if (strEnd == null || strEnd.length() == 0) {
			ToastUtil.show(RoutePlanning.this, "请选择终点");
			return;
		}
		if (strStart.equals(strEnd)) {
			ToastUtil.show(RoutePlanning.this, "起点与终点距离很近，您可以步行前往");
			return;
		}
