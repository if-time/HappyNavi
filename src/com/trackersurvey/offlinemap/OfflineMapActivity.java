...
//						Toast.LENGTH_SHORT).show()
				ToastUtil.show(OfflineMapActivity.this, (String)msg.obj);
				break;
...
//		initDialog();
	...
	private void initDialog() {
		...
		initDialog.setMessage(getResources().getString(R.string.getofflinecitylist));
	...
	public void onDownload(int status, int completeCode, String downName) {
		...
		case OfflineMapStatus.EXCEPTION_NETWORK_LOADING:
			Log.e("amap-download", "download: " + " EXCEPTION_NETWORK_LOADING "
					+ downName);
			Toast.makeText(OfflineMapActivity.this,getResources().getString(R.string.neterror), Toast.LENGTH_SHORT)
					.show();
			amapManager.pause();
			break;
	...
	public void onCheckUpdate(boolean hasNew, String name) {
		...
		if(hasNew){
			message.obj = getResources().getString(R.string.checkupdate) + name + " : " + getResources().getString(R.string.tips_hasnew);
		}
		else{
			message.obj = getResources().getString(R.string.checkupdate) + name + " : " + getResources().getString(R.string.tips_alreadynew);
	...
	public void onRemove(boolean success, String name, String describe) {
		...
		message.what = SHOW_MSG;
		if(success){
			message.obj = getResources().getString(R.string.delete) + name + " : " + getResources().getString(R.string.tips_success);
		}else{
			message.obj = getResources().getString(R.string.delete) + name + " : " + getResources().getString(R.string.tips_fail);
		}
		handler.sendMessage(message);
