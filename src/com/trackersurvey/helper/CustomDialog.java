...
public class CustomDialog extends Dialog {
	...
	public static class Builder {
		...
		private OnCheckedChangeListener noshowCheckChangeListener;
		...
		public Builder setCheckBox(OnCheckedChangeListener listener){
		...
		public CustomDialog create() {
			...
			//set checkbox
			if(isShowChebox){
				((CheckBox) layout.findViewById(R.id.noshow)).setOnCheckedChangeListener(new OnCheckedChangeListener() {
